...
tcp_epoll :: TCPEpollClient($DEV0, 9000, BATCH 1, VERBOSE 0);
tcp_echos :: EchoClient(ADDRESS 10.0.20.1, PORT 9000,  PARALLEL 10, LENGTH 1024, CONNECTIONS 100, VERBOSE 0);
